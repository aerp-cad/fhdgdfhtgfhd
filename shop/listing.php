<?php
	...
	if ($_POST['additem']) {
		...
		if ($_SESSION['items'] == "" or null) {
			$items = array(
			);
		}

		elseif ($_SESSION['items'] !== "" or null) {
			$items = $_SESSION['items'];
		}

		$_SESSION['items'] = array_unique(array_merge($item, $items));
...
<head>
	...
	<style>
		...
		.body .itembottom .buy a, .body .itembottom .buy input[type=submit] {
