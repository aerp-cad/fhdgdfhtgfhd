...
$target_dir = "../../clientarea/".$downloadfoldername."/";
$target_file = $target_dir .basename($_FILES["fileToUpload"]["name"]);
$filename = str_replace(" ", "", strtolower($name));
$uploadOk = 1;
$imageFileType = strtolower(pathinfo($target_file,PATHINFO_EXTENSION));

if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_dir.$filename.'.'.$imageFileType)) {
} else {
    echo "An error has occured while attempting to upload the file. Please try again.";
    die();
}
